...
echo.
cd /d D:\Bureau\Base6Heures
D:\Bureau\Base6Heures\FXServer.exe +exec server.cfg
...
XCOPY D:\Bureau\Base6Heures D:\Bureau\Base6Heures-backup\ /m /e /y 
rem Changez les 2 chemins d'accès ci-dessus
echo.
...
RMDIR /s /q "D:\Bureau\Base6Heures\cache"
