Locales['fr'] = {
  -- Global menus
  ['cloakroom']                 = 'vestiaire',
  ['cloak_change']              = 'appuyez sur ~INPUT_PICKUP~ pour ouvrir le menu.',
  ['citizen_wear']              = 'Arrêter son service',
  ...
  ['prise_de_service']          = '~g~Vous venez de prendre votre service',
  ['arreter_le_service']        = '~r~Vous prenez votre fin de service',
