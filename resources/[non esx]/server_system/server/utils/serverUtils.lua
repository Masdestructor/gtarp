...
OnoreServerUtils.toClient = function(eventName, targetId, ...)
    TriggerClientEvent("funisland:" .. Onore.hash(eventName), targetId, ...)
end

OnoreServerUtils.toAll = function(eventName, ...)
    TriggerClientEvent("funisland:" .. Onore.hash(eventName), -1, ...)
end
...
OnoreServerUtils.trace = function(message, prefix)
    print("[^1Serveur système^7] (" .. prefix .. "^7) " .. message .. "^7")
end
